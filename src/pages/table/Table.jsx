...
const Table = () => {
  ...
  return (
    <div className='text-slate-100 w-3/4 p-4 flex flex-col mx-auto'>
        <br/>
        <label className="block mb-2 text-xl text-gray-900 font-medium dark:text-white" for="file_input">Upload file for table</label>
        <input className="block w-full text-sm text-gray-900 border border-gray-300 mx-auto rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400" id="file_input" type="file"/>
        <br/>
